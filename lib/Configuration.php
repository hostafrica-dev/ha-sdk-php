...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.hostafrica.com';
    ...
    {
        $report  = 'PHP SDK (HostAfrica\SDK) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.1.0 - 2026-07-16' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.hostafrica.com",
                "description" => "HostAfrica API",
            ]
        ];
    }
