...
/**
 * DeletePowerTaskRequestContent Class Doc Comment
 *
 * @category Class
 * @package  HostAfrica\SDK
 * @author   OpenAPI Generator team
 ...
 */
class DeletePowerTaskRequestContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeletePowerTaskRequestContent';
    ...
    */
     ...
     * Sets task_id
     *
     * @param int $task_id Power task ID to delete
     *
     * @return self
     */
