...
/**
 * RestoreBackupRequestContent Class Doc Comment
 *
 * @category Class
 * @package  HostAfrica\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RestoreBackupRequestContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestoreBackupRequestContent';
    ...
    */
     ...
     * Sets backup_id
     *
     * @param string $backup_id Backup identifier for the backup to restore
     *
     * @return self
     */
