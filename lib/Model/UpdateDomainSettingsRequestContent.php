...
/**
 * UpdateDomainSettingsRequestContent Class Doc Comment
 *
 * @category Class
 * @package  HostAfrica\SDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateDomainSettingsRequestContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDomainSettingsRequestContent';
    ...
    */
     ...
     * Sets domain_id
     *
     * @param string $domain_id Domain service id - must be sent as a string
     *
     * @return self
     */
     ...
     * Sets gateway
     *
     * @param string|null $gateway Payment gateway slug when enabling a paid addon (e.g. stripe)
     *
     * @return self
     */
