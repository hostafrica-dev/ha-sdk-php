...
/**
 * DeleteSnapshotRequestContent Class Doc Comment
 *
 * @category Class
 * @package  HostAfrica\SDK
 * @author   OpenAPI Generator team
 ...
 */
class DeleteSnapshotRequestContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteSnapshotRequestContent';
    ...
    */
     ...
     * Sets snapshot_name
     *
     * @param string $snapshot_name Snapshot name to delete
     *
     * @return self
     */
