...
/**
 * RollbackSnapshotRequestContent Class Doc Comment
 *
 * @category Class
 * @package  HostAfrica\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RollbackSnapshotRequestContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RollbackSnapshotRequestContent';
    ...
    */
     ...
     * Sets snapshot_name
     *
     * @param string $snapshot_name Snapshot name to rollback to
     *
     * @return self
     */
