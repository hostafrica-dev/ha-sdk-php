...
/**
 * UpdateSnapshotJobRequestContent Class Doc Comment
 *
 * @category Class
 * @package  HostAfrica\SDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateSnapshotJobRequestContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSnapshotJobRequestContent';
    ...
    */
     ...
     * Sets job_id
     *
     * @param string $job_id Snapshot job ID to update
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name New name for the snapshot job
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description New description for the snapshot job
     *
     * @return self
     */
     ...
     * Gets period
     *
     * @return \HostAfrica\SDK\Model\SnapshotJobPeriod|null
     */
     ...
     * Sets period
     *
     * @param \HostAfrica\SDK\Model\SnapshotJobPeriod|null $period period
     *
     * @return self
     */
    ...
    public function setStartTime($start_time)
    {
        ...
        if ((!preg_match("/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/", ObjectSerializer::toString($start_time)))) {
            throw new \InvalidArgumentException("invalid value for \$start_time when calling UpdateSnapshotJobRequestContent., must conform to the pattern /^([01]?[0-9]|2[0-3]):[0-5][0-9]$/.");
        }
