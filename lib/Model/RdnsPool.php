...
/**
 * RdnsPool Class Doc Comment
 *
 * @category Class
 * @description A subnet pool entry within an available rDNS item
 * @package  HostAfrica\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RdnsPool implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RdnsPool';
    ...
    */
     ...
     * Sets pool
     *
     * @param string $pool Network address of the pool
     *
     * @return self
     */
