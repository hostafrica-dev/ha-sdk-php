...
/**
 * UpdateSnapshotRequestContent Class Doc Comment
 *
 * @category Class
 * @package  HostAfrica\SDK
 * @author   OpenAPI Generator team
 ...
 */
class UpdateSnapshotRequestContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSnapshotRequestContent';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('snapshot_name', $data ?? [], null);
    ...
    */
     ...
     * Sets snapshot_name
     *
     * @param string $snapshot_name Snapshot name to update
     *
     * @return self
     */
    public function setSnapshotName($snapshot_name)
    {
        if (is_null($snapshot_name)) {
            throw new \InvalidArgumentException('non-nullable snapshot_name cannot be null');
        }
     ...
     * Sets description
     *
     * @param string|null $description New description for the snapshot
     *
     * @return self
     */
