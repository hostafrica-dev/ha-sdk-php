...
/**
 * TriggerReinstallRequestContent Class Doc Comment
 *
 * @category Class
 * @package  HostAfrica\SDK
 * @author   OpenAPI Generator team
 ...
 */
class TriggerReinstallRequestContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TriggerReinstallRequestContent';
    ...
    */
     ...
     * Sets template
     *
     * @param string $template Template identifier for the OS to reinstall
     *
     * @return self
     */
