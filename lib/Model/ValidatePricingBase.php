...
/**
 * ValidatePricingBase Class Doc Comment
 *
 * @category Class
 * @description Base price breakdown (recurring + setup)
 * @package  HostAfrica\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ValidatePricingBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ValidatePricingBase';
