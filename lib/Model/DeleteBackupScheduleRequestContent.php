...
/**
 * DeleteBackupScheduleRequestContent Class Doc Comment
 *
 * @category Class
 * @package  HostAfrica\SDK
 * @author   OpenAPI Generator team
 ...
 */
class DeleteBackupScheduleRequestContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteBackupScheduleRequestContent';
    ...
    */
     ...
     * Sets schedule_id
     *
     * @param string $schedule_id Backup schedule ID to delete
     *
     * @return self
     */
