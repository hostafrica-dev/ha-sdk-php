...
**job_id** | **string** | Snapshot job ID to update |
**name** | **string** | New name for the snapshot job | [optional]
**description** | **string** | New description for the snapshot job | [optional]
**vmstate** | **bool** | Whether to include VM state in the snapshot | [optional]
**period** | [**\HostAfrica\SDK\Model\SnapshotJobPeriod**](SnapshotJobPeriod.md) |  | [optional]
